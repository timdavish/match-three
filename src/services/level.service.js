...
const smallPos = [
  ...
  { id: generateUid(), row: 2, col: 1, active: true, columnStart: false, blocker: BLOCKERS.HONEY1, condition: CONDITIONS.NONE, flowDirection: DIRECTIONS.NONE, feedDirection: DIRECTIONS.UP },
